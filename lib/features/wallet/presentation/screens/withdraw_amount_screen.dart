...
class _WithdrawAmountScreenState extends State<WithdrawAmountScreen> {
  ...
  void _goToSelectBank() {
    context.push('/withdraw/select-bank', extra: {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Rút tiền', style: GoogleFonts.dmSans(color: AppColors.textPrimary, fontWeight: FontWeight.bold)),
      ),
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('SỐ DƯ KHẢ DỤNG (VÍ CỦA TÔI)', style: GoogleFonts.dmSans(fontSize: 10, fontWeight: FontWeight.bold, color: AppColors.textSecondary, letterSpacing: 0.8)),
                  const SizedBox(height: 8),
                  _isLoadingBalance
                      ? const SizedBox(width: 20, height: 20, child: CircularProgressIndicator(strokeWidth: 2))
                      : Text(_formatCurrency(_availableBalance), style: GoogleFonts.dmSans(fontSize: 26, fontWeight: FontWeight.bold, color: AppColors.textPrimary)),
                ],
              ),
            ),
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                child: Text('Chọn ngân hàng đích', style: GoogleFonts.dmSans(fontSize: 16, fontWeight: FontWeight.bold)),
              ),
            ),
          ],
        ),
